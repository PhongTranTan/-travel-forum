            ...
            <div class="scroll__container" id="scroll__container">
                <nav class="mdl-navigation">
                    ...
                    <div class="sub-navigation @if(request()->routeIs('admin.category.*')) sub-navigation--show @endif">
                        <a
                            class="mdl-navigation__link @if(request()->routeIs('admin.category.*')) sub-navigation--show @endif">
                    ...
                    <div class="sub-navigation @if(request()->routeIs('admin.post.*')) sub-navigation--show @endif">
                        <a
                            class="mdl-navigation__link @if(request()->routeIs('admin.post.*')) sub-navigation--show @endif">
