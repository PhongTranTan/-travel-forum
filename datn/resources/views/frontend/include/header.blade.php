        ...
        <div class="navbar navbar-expand-lg navbar-light"><a class="navbar-brand" href="/"><img src="/images/logo.png"
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown"
                aria-controls="navbarNavDropdown" aria-expanded="true" aria-label="Toggle navigation"><span
                    class="icon_menu-square_alt2 text-light" aria-hidden="true"></span>
            </button>
            <div class="navbar-collapse justify-content-end collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" id="navbarDropdownMenuLink" href="#" data-toggle="dropdown"
                    ...
                    @else
                    <li class="nav-item">
                        <a class="nav-link fc-logout" 
                            href="#modalLogin" data-toggle="modal"
                        >
                            Login
                        </a>
                    </li>
